...
const loading = useRef(null);
    ...
    async function inserirProduto () {
        ...
        if(nome === '' || categoria === '' || precode === '' ||  precopor  === '' 
        ||  avaliacao  === '' ||  descricao  === '' ||  estoque  === '' || img === ''){
        ...
        if ( isNaN(precodeE) || isNaN(precoporE)
        || isNaN(avaliacaoE) || isNaN(estoqueE) ){
        ...
        if (idProduto > 0 ){
            let P = await api.alterar(idProduto, nome, categoria, precodeE,
                                      precoporE, avaliacaoE, descricao, estoqueE, img)
            ...
            let P = await api.inserir(nome, categoria, precodeE, 
                                      precoporE, avaliacaoE, descricao, estoqueE, img);
    ...
    async function removerProduto (idProduto) {
        confirmAlert({
            title: 'Reover produto.',
            message: 'Você deseja remover o produto ' + idProduto + '?',
            buttons: [
